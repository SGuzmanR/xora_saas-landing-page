        ...
        <div className="container">
          <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col features-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
            ...
            <ul className="relative flex justify-around flex-grow px-[5%] border-2 border-s3 rounded-7xl max-md:hidden">
              <div className="absolute bg-se/20 top-[38%] left-0 right-0 w-full h-[1px] z-10" />
              ...
              {details.map((detail) => (
                <li key={detail.id} className="relative pt-16 px-4 pb-14">
                  ...
                  <h3 className="realtive z-2 max-w-36 mx-auto my-0 base-smaill text-center uppercase">{detail.title}</h3>
                </li>
              ))}
            </ul>
          </div>
